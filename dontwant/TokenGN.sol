...
contract OriginalGN is StandardToken {
    ...
    */
    string public name = "OriginalGN";                   //fancy name: eg Simon Bucks
    ...
    string public symbol = "OGN";                 //An identifier: eg SBX
...
//make sure this function name matches the contract name above. So if you're token is called TutorialToken, make sure the //contract name above is also TutorialToken instead of ERC20Token
    ...
    function OriginalGN(
        ...
        totalSupply = 433;                        // Update total supply (100000 for example)
